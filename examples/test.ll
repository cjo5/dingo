...
@main.localVec3 = private unnamed_addr constant %struct.Vec3 { i32 2, %struct.Vec2 { i32 1, i32 3 } }, align 4
...
define i32 @main() #0 {
  ...
  %4 = bitcast %struct.Vec3* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %4, i8* bitcast (%struct.Vec3* @main.localVec3 to i8*), i64 12, i32 4, i1 false)
  %5 = getelementptr inbounds %struct.Vec3, %struct.Vec3* %2, i32 0, i32 1
  %6 = getelementptr inbounds %struct.Vec2, %struct.Vec2* %5, i32 0, i32 1
  %7 = load i32, i32* %6, align 4
  %8 = mul nsw i32 %7, 3
  store i32 %8, i32* %3, align 4
  %9 = load i32, i32* %3, align 4
  %10 = call i32 @puti(i32 %9)
  ret i32 0
}
